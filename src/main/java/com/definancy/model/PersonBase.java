...
public class PersonBase {
   ...
   * @throws IOException if the JSON Element is invalid with respect to PersonBase
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!PersonBase.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in PersonBase is not found in the empty JSON string", PersonBase.openapiRequiredFields.toString()));
        }
      }
  ...
  /**
   * Create an instance of PersonBase given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of PersonBase
   * @throws IOException if the JSON string is invalid with respect to PersonBase
   */
  public static PersonBase fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, PersonBase.class);
  }

  /**
   * Convert an instance of PersonBase to an JSON string
   *
   * @return JSON string
   */
